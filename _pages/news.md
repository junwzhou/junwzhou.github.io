...
<div style="display: flex; gap: 30px; margin-bottom: 40px; justify-content: center;">
  ...
  <a href="#bbq" style="flex: 1; max-width: 250px; text-decoration: none;">
    <div style="background: #fff; border: 2px solid #eee; border-radius: 12px; overflow: hidden; text-align: center; transition: transform 0.3s; padding: 20px;">
      <img src="../images/烧烤.jpg" alt="东湖烧烤" style="width: 100%; height: 150px; object-fit: cover; border-radius: 8px;">
      <h4 style="margin: 15px 0; font-size: 1.2em; color: #333;">东湖烧烤</h4>
    </div>
  </a>
  <a href="#jobfair" style="flex: 1; max-width: 250px; text-decoration: none;">
    <div style="background: #fff; border: 2px solid #eee; border-radius: 12px; overflow: hidden; text-align: center; transition: transform 0.3s; padding: 20px;">
      <img src="../images/themeeting.jpg" alt="求职分享会" style="width: 100%; height: 150px; object-fit: cover; border-radius: 8px;">
